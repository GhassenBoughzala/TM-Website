...
router.post(
  ...
  isRequestValidated,
  async (req, res) => {
    const { firstName, lastName, email, phone, institution, country, city, password } = req.body;
    ...
    if (user) {
      ...
      try {
        user = new User({ firstName, lastName, email, phone, institution, country ,city, password });
